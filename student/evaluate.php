...
// If a valid academic year is found, update the session
if ($academic) {
...
// Fetch restriction list for evaluation based on the academic year and class
$restriction_query = "
...
";
$restriction = $conn->query($restriction_query);
?>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                ?>
                <a class="list-group-item list-group-item-action <?php echo isset($rid) && $rid == $row['id'] ? 'active' : '' ?>" href="./index.php?page=evaluate&rid=<?php echo $row['id'] ?>&sid=<?php echo $row['sid'] ?>&fid=<?php echo $row['fid'] ?>">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    <form id="manage-evaluation">
                        ...
                        <?php 
                        // Fetch criteria and related questions for the current academic year
